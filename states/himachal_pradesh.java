...
import javax.swing.*;
public class himachal_pradesh extends JFrame 
{
	JFrame f;
	JTabbedPane t;
	...
	public himachal_pradesh()
	{
		...
		l.setIcon(new ImageIcon(getClass().getResource("/states/himachal_pradesh.jpg")));
		l1.setBounds(0,0,733,506);
		l1.setIcon(new ImageIcon(getClass().getResource("/states/himachal_about.png")));
		l2.setBounds(0,0,800,550);
		l2.setIcon(new ImageIcon(getClass().getResource("/states/history_himachal.png")));
		l3.setBounds(0,0,800,550);
		l3.setIcon(new ImageIcon(getClass().getResource("/states/himachal_information.png")));
		l4.setBounds(0,0,800,550);
		l4.setIcon(new ImageIcon(getClass().getResource("/states/tourism_himachal.png")));
		p1 = new JPanel();
		p2 = new JPanel();
		p3 = new JPanel();
		p4 = new JPanel();
