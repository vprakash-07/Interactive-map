...
import javax.swing.*;
public class west_bengal extends JFrame 
{
	JFrame f;
	JTabbedPane t;
	...
	public west_bengal()
	{
		...
		l.setIcon(new ImageIcon(getClass().getResource("/states/west_bengal.jpg")));
		l1.setBounds(0,0,733,506);
		l1.setIcon(new ImageIcon(getClass().getResource("/states/about_west_bengal.png")));
		l2.setBounds(0,0,800,550);
		l2.setIcon(new ImageIcon(getClass().getResource("/states/history_west_bengal.png")));
		l3.setBounds(0,0,800,550);
		l3.setIcon(new ImageIcon(getClass().getResource("/states/information_west_bengal.png")));
		l4.setBounds(0,0,800,550);
		l4.setIcon(new ImageIcon(getClass().getResource("/states/tourism_west_bengal.png")));
		p1 = new JPanel();
		p2 = new JPanel();
		p3 = new JPanel();
		p4 = new JPanel();
