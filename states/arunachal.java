...
import javax.swing.*;
public class arunachal extends JFrame 
{
	JFrame f;
	JTabbedPane t;
	...
	public arunachal()
	{
	    f = new JFrame("Arunachal Pradesh");
		t = new JTabbedPane();
		l = new JLabel();
		l1 = new JLabel();
		l2 = new JLabel();
		...
		l.setIcon(new ImageIcon(getClass().getResource("/states/arunachal.jpg")));
		l1.setBounds(0,0,733,506);
		l1.setIcon(new ImageIcon(getClass().getResource("/states/about_arunachal.png")));
		l2.setBounds(0,0,800,550);
		l2.setIcon(new ImageIcon(getClass().getResource("/states/history_arunachal.png")));
		l3.setBounds(0,0,800,550);
		l3.setIcon(new ImageIcon(getClass().getResource("/states/information_arunachal.png")));
		l4.setBounds(0,0,800,550);
		l4.setIcon(new ImageIcon(getClass().getResource("/states/tourism_arunachal.png")));
		p1 = new JPanel();
		p2 = new JPanel();
		p3 = new JPanel();
		p4 = new JPanel();
