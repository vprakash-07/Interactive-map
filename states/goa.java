...
import javax.swing.*;
public class goa extends JFrame 
{
	JFrame f;
	JTabbedPane t;
	...
	public goa()
	{
		...
		l.setIcon(new ImageIcon(getClass().getResource("/states/goa.jpg")));
		l1.setBounds(0,0,733,506);
		l1.setIcon(new ImageIcon(getClass().getResource("/states/about_goa.png")));
		l2.setBounds(0,0,800,550);
		l2.setIcon(new ImageIcon(getClass().getResource("/states/history_goa.png")));
		l3.setBounds(0,0,800,550);
		l3.setIcon(new ImageIcon(getClass().getResource("/states/information_goa.png")));
		l4.setBounds(0,0,800,550);
		l4.setIcon(new ImageIcon(getClass().getResource("/states/tourism_goa.png")));
		p1 = new JPanel();
		p2 = new JPanel();
		p3 = new JPanel();
		p4 = new JPanel();
