...
import javax.swing.*;
public class odisha extends JFrame 
{
	JFrame f;
	JTabbedPane t;
	...
	public odisha()
	{
		...
		l.setIcon(new ImageIcon(getClass().getResource("/states/odisha.jpg")));
		l1.setBounds(0,0,733,506);
		l1.setIcon(new ImageIcon(getClass().getResource("/states/about_odisha.png")));
		l2.setBounds(0,0,800,550);
		l2.setIcon(new ImageIcon(getClass().getResource("/states/history_odisha.png")));
		l3.setBounds(0,0,800,550);
		l3.setIcon(new ImageIcon(getClass().getResource("/states/information_odisha.png")));
		l4.setBounds(0,0,800,550);
		l4.setIcon(new ImageIcon(getClass().getResource("/states/tourism_odisha.png")));
		p1 = new JPanel();
		p2 = new JPanel();
		p3 = new JPanel();
		p4 = new JPanel();
