...
import javax.swing.*;
public class uttar_pradesh extends JFrame 
{
	JFrame f;
	JTabbedPane t;
	JPanel p,p1,p2,p3,p4,p5;
	JLabel l,l1,l2,l3,l4;
	public uttar_pradesh()
	{
	    f = new JFrame("Uttar Pradesh");
		t = new JTabbedPane();
		l = new JLabel();
		l1 = new JLabel();
		l2 = new JLabel();
		...
		l.setIcon(new ImageIcon(getClass().getResource("/states/uttar_pradesh.gif")));
		l1.setBounds(0,0,733,506);
		l1.setIcon(new ImageIcon(getClass().getResource("/states/about_uttar_pradesh.png")));
		l2.setBounds(0,0,800,550);
		l2.setIcon(new ImageIcon(getClass().getResource("/states/history_uttar_pradesh.png")));
		l3.setBounds(0,0,800,550);
		l3.setIcon(new ImageIcon(getClass().getResource("/states/information_uttar_pradesh.png")));
		l4.setBounds(0,0,800,550);
		l4.setIcon(new ImageIcon(getClass().getResource("/states/tourism_uttar_pradesh.png")));
		p1 = new JPanel();
		p2 = new JPanel();
		p3 = new JPanel();
		p4 = new JPanel();
