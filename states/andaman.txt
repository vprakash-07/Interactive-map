...
public class ladakh extends JFrame 
{
	...
	public ladakh()
	{
		...
		l.setIcon(new ImageIcon(getClass().getResource("/states/ladakh.jpg")));
		l1.setBounds(0,0,733,506);
		l1.setIcon(new ImageIcon(getClass().getResource("/states/about_ladakh.png")));
		l2.setBounds(0,0,800,550);
		l2.setIcon(new ImageIcon(getClass().getResource("/states/history_ladakh.png")));
		l3.setBounds(0,0,800,550);
		l3.setIcon(new ImageIcon(getClass().getResource("/states/information_ladakh.png")));
		l4.setBounds(0,0,800,550);
		l4.setIcon(new ImageIcon(getClass().getResource("/states/tourism_ladakh.png")));
		p1 = new JPanel();
		p2 = new JPanel();
		p3 = new JPanel();
		p4 = new JPanel();
